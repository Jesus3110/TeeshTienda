...
function ModalProducto({ 
  ...
  const productosSimilares = productosRelacionados
    .filter(p => p.categoria === producto.categoria && p.idFirebase !== producto.idFirebase)
    .slice(0, 3);
            ...
            <div className="modal-producto-info">
              ...
              <div className="producto-descripcion-modal">
                ...
                <div className="shipping-info">
                  <span className="shipping-badge">Envío rápido disponible</span>
                </div>
              </div>
              ...
              <div className="product-specs">
                ...
                <div className="specs-grid">
                  <div className="spec-item">
                    ...
                    <span className="spec-value">{producto.marca || 'No especificada'}</span>
                  </div>
                  <div className="spec-item">
              ...
              <div className="grid-productos-relacionados">
                {productosSimilares.map((productoRel) => {
                  const descuentoRel = productoRel.descuentoAplicado 
                    ? descuentos.find(d => d.id === productoRel.descuentoAplicado)
                    : null;
                  const precioRelConDescuento = descuentoRel 
                    ? (productoRel.precio * (1 - descuentoRel.porcentaje / 100)).toFixed(2)
