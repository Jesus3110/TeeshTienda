  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        {exito && <p style={{ color: "green" }}>✅ Perfil actualizado. Redirigiendo...</p>}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input name="nuevaPass" placeholder="Nueva Contraseña" onChange={handleChange} type="password" />
